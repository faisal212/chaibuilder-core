...
import { D as j, e as q, f as G, g as L, o as U, p as D } from "./index-CrqH_FTA.js";
import { useQueryClient as $, useMutation as B } from "@tanstack/react-query";
import { toast as P } from "sonner";
import { ai as O, aj as k, ag as M, ak as Q } from "./index-BJrxRPBj.js";
import { S as V } from "./slug-input-BRiNZT9I.js";
const z = () => {
  const s = O(), o = $(), g = k();
  return B({
