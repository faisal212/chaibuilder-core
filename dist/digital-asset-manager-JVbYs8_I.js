...
import { p as V, T as it, ae as _, F as P, G as q, H as B, D as at, e as lt, f as rt, g as nt, o as st, q as ct, af as ot } from "./index-C3s5Ng7i.js";
import dt from "compressorjs";
import { useQueryClient as ie, useMutation as ae, useQuery as ve } from "@tanstack/react-query";
import { ai as R, aj as K, ag as A } from "./index-VfpBsgmZ.js";
...
}, wt = pe.lazy(() => import("./image-editor-BuCaO8MY.js")), bt = 25 * 1024 * 1024, At = ({ isUpdatingAsset: s, allowedTypes: l, uploadAssets: u, isUploadingAsset: i, onUploaded: c }) => {
  const { t: a } = te(), [r, k] = y(() => {
